...
import ProductRanking from "./ProductRanking";  // Importa ProductRanking
      ...
      >
        ...
        <div className="text-content px-3 py-2">
          ...
          <ul className="nav flex-column">
            ...
            <li className="nav-item mb-3">
              <Link className="nav-link text-white d-flex align-items-center" to="/dashboard/orders">
                <i className="bi bi-clipboard-data fs-4"></i>
                <span className={`ms-2 ${isSidebarCollapsed ? "d-none" : ""}`}>Orders</span>
              </Link>
            </li>
            <li className="nav-item mb-3">
